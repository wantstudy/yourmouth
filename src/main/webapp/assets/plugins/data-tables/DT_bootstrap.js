/* Set the defaults for jqGrids initialisation */
$.extend( true, $.fn.jqGrid.defaults, {
...
$.extend( $.fn.jqGridExt.oStdClasses, {
	"sWrapper": "dataTables_wrapper"
} );


/* API method to get paging information */
$.fn.jqGridExt.oApi.fnPagingInfo = function ( oSettings )
{
	return {
...
$.extend( $.fn.jqGridExt.oPagination, {
	"bootstrap": {
 ...
 */
if ( $.fn.jqGrid.TableTools ) {
	// Set the classes that TableTools uses to something suitable for Bootstrap
	$.extend( true, $.fn.jqGrid.TableTools.classes, {
		"container": "btn-group",
		"buttons": {
			"normal": "btn default",
	...
	$.extend( true, $.fn.jqGrid.TableTools.DEFAULTS.oTags, {
		"collection": {
			"container": "ul",
			"button": "li",
			"liner": "a"
